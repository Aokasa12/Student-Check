...
class ComeCheck(Toplevel):
    def __init__(self,parent):
        ...
        self.radio = Radiobutton(self.mainFrame,text = "เข้าเรียนตรงเวลา" , variable=self.choice,bg="#F4E8DA",value=1)
        self.radio.pack(side=TOP, padx=(0,350),pady=10)

        self.radio2 = Radiobutton(self.mainFrame,text = "เข้าเรียนสาย" , variable=self.choice,bg="#F4E8DA",value=2)
        self.radio2.pack(side=TOP, padx=(0,369),pady=10)

        self.radio3 = Radiobutton(self.mainFrame,text = "เรียน Onsite" , variable=self.choice,bg="#F4E8DA",value=3)
        self.radio3.pack(side=TOP, padx=(0,365),pady=10)

        self.radio4 = Radiobutton(self.mainFrame,text = "เรียน Online" , variable=self.choice,bg="#F4E8DA",value=4)
        self.radio4.pack(side=TOP, padx=(0,365),pady=5)
        ...
        self.radio5 = Radiobutton(self.tinyFrame,text = "อื่นๆ (ไม่ควรเกิน 30 ตัวอักษร)" , variable=self.choice,bg="#F4E8DA",value=5)
        self.radio5.pack(side=TOP, padx=(0,295),pady=5)
        self.txt = StringVar()
